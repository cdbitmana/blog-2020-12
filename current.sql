...
INSERT INTO `article` VALUES (1,'2020-12-17 13:28:21','2021-01-13 13:37:24','자바) Switch 구문','# SWITCH\r\n```java\r\nswitch (변수명) {\r\n          case 조건1:\r\n          실행코드1;\r\n\r\n          case 조건2:\r\n          실행코드2;\r\n\r\n          default:\r\n          실행코드3;\r\n}\r\n```\r\n\r\n변수가 \r\n조건1에 참이라면 실행코드1부터 실행코드3까지 순차적으로 실행\r\n조건2에 참이라면 실행코드2부터 실행코드3까지 순차적으로 실행\r\n조건 1과 조건2에 모두 맞지 않으면 실행코드3만 실행\r\n\r\n\r\n조건에 맞는 실행코드만 실행하고 싶다면 break; 를 넣어준다.\r\n# 예시\r\n```java\r\nint value = 1;\r\n\r\nswitch (value) {\r\n          case 1 :\r\n          System.out.println(\"1\");\r\n          break;\r\n\r\n          case 2 :\r\n          System.out.println(\"2\");\r\n          break;\r\n\r\n          case 3 :\r\n          System.out.println(\"3\");\r\n          break;\r\n\r\n         default :\r\n         System.out.println(\"그 외의 숫자\");\r\n}\r\n```\r\n',1,2,4,0,1),(2,'2020-12-17 15:25:02','2021-01-13 13:37:24','자바) 배열 정렬하는 식','```java\r\nint[] arr = new int[N];\r\n\r\n  for (int i = 0 ; i < arr.length ; i++) {\r\n    for (int j = 0 ; j < arr.length-i-1 ; j++) {\r\n      if(arr[j] < arr[j+1]){\r\n          int temp = arr[j+1];\r\n          arr[j+1] = arr[j];\r\n          arr[j] = temp;\r\n      }  \r\n    }\r\n  }\r\n```\r\n\r\n배열의 앞 뒤 값을  비교해서 작은 값을 뒤로 보내고, 다시 앞 뒤로 비교한다.\r\n이 과정을 반복해서 제일 작은 값은 마지막 위치로 가게 되고 제일 마지막 값은 이미 제일 작은 값이므로 또다시 비교할 필요가 없다.\r\n이 과정을 다시 반복하면 배열은 내림차순으로 정렬된다.',1,2,4,0,0),(3,'2020-12-17 15:25:02','2021-01-13 13:37:25','MySQL) 문자열 합치기 CONCAT','# CONCAT\r\n```MySql\r\nCONCAT(\'문\',\'자\',\'열\')\r\n```\r\n-> \'문자열\'\r\n\r\n',1,2,3,0,0),(4,'2020-12-17 15:25:02','2021-01-13 13:37:26','MySQL) INNER JOIN','# INNER JOIN\r\n```mysql\r\nSELECT * FROM 테이블명1\r\nINNER JOIN 테이블명2\r\nON 테이블명1.컬럼명 = 테이블명2.컬럼명;\r\n```\r\n테이블명1.컬럼과 테이블명2.컬럼의 값이 같은 것들만 합쳐져 나온다.',1,2,2,0,0),(5,'2020-12-20 09:06:01','2021-01-13 13:37:26','자바) 폴더와 하위파일 삭제하는 메소드','# 폴더와 하위파일 삭제하는 메소드\r\n```java\r\npublic static void deleteDir(String filePath) { \r\n\r\n          File deleteFolder = new File(filePath); \r\n\r\n               if(deleteFolder.exists()) { \r\n                   File[] deleteFolderList = deleteFolder.listFiles();\r\n                           for(int i = 0 ; i < deleteFolderList.length; i++) {\r\n                                   if(deleteFolderList[i].isFile()) { \r\n                                        deleteFolderList[i].delete();\r\n                                    } else {\r\n                                     deleteDir(deleteFolderList[i].getPath()); \r\n                                    } \r\n                                    deleteFolderList[i].delete();\r\n                               } deleteFolder.delete(); \r\n                       } \r\n              }\r\n```\r\n',1,2,3,0,0),(6,'2020-12-21 21:45:32','2021-01-13 13:37:27','HTML,CSS) box-sizing 속성','content-box 는 기본으로 적용되는 키워드.\r\n\r\nwidth속성과 height속성이 글자가 들어가는 영역의 크기를 지정하게 만든다.\r\n\r\n(width:100px , height:100px 인 영역에 border,margin,padding등의 요소가 추가되어도 width와 height는 100px로 고정)\r\n\r\n(따라서 태그의 전체 영역은 width,height의 크기에서 border,margin,padding만큼 커지게 된다.)\r\n\r\n \r\n\r\nborder-box 는 width속성과 height속성이 테두리를 포함한 영역의 크기를 지정하게 만든다.\r\n\r\n(width:100px , height:100px 인 영역에 border,margin,padding등의 요소가 추가되면 border와 padding의 크기만큼 width와 height가 줄어든다. margin은 영역의 바깥에 여백을 주는것이기 때문에 상관이 없다.)\r\n\r\n',1,2,2,0,0),(7,'2020-12-21 21:55:28','2021-01-13 13:37:27','JAVASCRIPT) replace를 replaceAll처럼 사용하기','자바스크립트에는 replaceAll 이 없다.\r\nreplaceAll처럼 쓰려면 정규식표현을 사용.\r\n```javascript\r\nstring.replace(\"#\" , \"\"); \r\nstring.replace9(/#/gi , \"\");\r\n```\r\n\r\nreplace 함수에서와 같이 사용하되, 따옴표를 / 슬래시로 대체하고, 뒤에 gi 를 붙이면 replaceAll() 과 같은 기능을 한다.\r\n\r\n* g : 발생할 모든 패턴에 대한 전역 검색\r\n\r\n* i : 대/소문자 구분 안함\r\n\r\n* m : 여러 줄 검색\r\n',1,2,2,0,0),(12,'2020-12-21 09:34:32','2021-01-13 13:37:27','공지사항입니다. 😄','앞으로 풀스택 개발 관련 글이 올라옵니다.\r\n😄😄😄',1,1,2,0,0),(13,'2021-01-05 21:30:14','2021-01-13 13:37:28','게시판 이용 수칙','각 게시판에 맞는 글을 작성해 주세요.',1,1,1,0,0),(14,'2021-01-06 10:36:51','2021-01-13 13:37:28','Vue) Array.prototype.map()','map() 메소드는 배열 내의 모든 요소 각각에 대하여 주어진 함수를 호출한 결과를 모아 새로운 배열을 반환합니다.\r\n\r\n```javascript\r\narray.map(function(row,index){ \r\n  return row * 2;\r\n});\r\n// row 는 처리할 요소 , index 는 처리할 현재 요소의 인덱스\r\n\r\n// map() 메소드는 다음과 같이 사용할 수도 있다.\r\narray.map((row,index) = > {\r\n   return row * 2;\r\n});\r\n```\r\n\r\n',1,2,3,0,0),(15,'2021-01-06 10:40:09','2021-01-13 13:37:29','Vue) Array.prototype.filter()','filter() 메소드는 주어진 함수의 테스트를 통과하는 모든 요소를 모아 새로운 배열로 반환합니다.\r\n\r\n```javascript\r\narray.filter(function(row,index) {\r\n  return row > 10;\r\n});\r\n// row 는 처리할 요소, index 는 현재 처리할 요소의 인덱스\r\n\r\n// filter() 메소드는 다음과 같이 사용할 수도 있다.\r\narray.filter((row,index) => {\r\n  return row > 10;\r\n});\r\n```',1,2,4,0,0),(16,'2021-01-06 10:42:44','2021-01-13 13:37:29','Vue) Array.prototype.some()','some() 메서드는 배열 안의 어떤 요소라도 주어진 판별 함수를 통과하는지 테스트합니다.\r\n```javascript\r\narray.some((row, i) => {\r\n  return row == 15;\r\n});\r\n// row 는 처리할 요소, index 는 현재 처리할 요소의 인덱스\r\n\r\n// some() 메소드는 다음과 같이 사용할 수도 있다.\r\narray.some((row,index) => {\r\n  return row > 10;\r\n});\r\n```',1,2,2,0,0),(17,'2021-01-06 10:43:58','2021-01-13 13:37:30','Vue) Array.prototype.forEach()','forEach() 메서드는 주어진 함수를 배열 요소 각각에 대해 실행합니다.\r\n```javascript\r\narray.forEach((row, i) => {\r\n  console.log(i);\r\n});\r\n// row 는 처리할 요소, index 는 현재 처리할 요소의 인덱스\r\n\r\n// forEach() 메소드는 다음과 같이 사용할 수도 있다.\r\narray.forEach((row,index) => {\r\n  return row > 10;\r\n});\r\n```',1,2,4,0,0),(1186,'2021-01-09 20:30:14','2021-01-13 13:37:31','제목_1','내용_7',1,3,0,0,0),(1187,'2021-01-09 20:30:15','2021-01-13 13:37:33','제목_9','내용_4',1,3,0,0,0),(1188,'2021-01-09 20:30:15','2021-01-13 13:37:34','제목_1','내용_2',1,3,0,0,0),(1189,'2021-01-09 20:30:15','2021-01-13 13:37:35','제목_8','내용_2',1,3,0,0,0),(1190,'2021-01-09 20:30:15','2021-01-13 13:37:35','제목_7','내용_8',1,3,0,0,0),(1191,'2021-01-09 20:30:15','2021-01-13 13:37:36','제목_8','내용_8',1,3,0,0,0),(1192,'2021-01-09 20:30:15','2021-01-13 13:37:37','제목_2','내용_8',1,3,0,0,0),(1193,'2021-01-09 20:30:15','2021-01-13 13:37:37','제목_3','내용_9',1,3,0,0,0),(1194,'2021-01-09 20:30:15','2021-01-13 13:37:38','제목_8','내용_1',1,3,0,0,0),(1195,'2021-01-09 20:30:15','2021-01-13 13:37:38','제목_1','내용_2',1,3,0,0,0),(1196,'2021-01-09 20:30:15','2021-01-13 13:37:39','제목_7','내용_6',1,3,0,0,0),(1197,'2021-01-09 20:30:16','2021-01-13 13:37:40','제목_1','내용_8',1,3,0,0,0),(1198,'2021-01-09 20:30:16','2021-01-13 13:37:41','제목_4','내용_6',1,3,0,0,0),(1199,'2021-01-09 20:30:16','2021-01-13 13:37:41','제목_6','내용_3',1,3,0,0,0),(1200,'2021-01-09 20:30:16','2021-01-13 13:37:42','제목_4','내용_4',1,3,0,0,0),(1201,'2021-01-09 20:30:16','2021-01-13 13:37:43','제목_6','내용_9',1,3,0,0,0),(1202,'2021-01-09 20:30:16','2021-01-13 13:37:43','제목_5','내용_7',1,3,0,0,0),(1203,'2021-01-09 20:30:16','2021-01-13 13:37:44','제목_1','내용_4',1,3,0,0,0),(1204,'2021-01-09 20